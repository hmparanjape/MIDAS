...
PLACEHOLDER="STAMPEDE.USER.SCRATCHDIR"
SCRATHPATH="${SCRATCH//\//\\/}"
sed -e "s/$PLACEHOLDER/${SCRATCHPATH}/" sites32.xml.stampede > sites32.xml

echo "Congratulations, you can now use MIDAS on Stampede to run FarField analysis"
